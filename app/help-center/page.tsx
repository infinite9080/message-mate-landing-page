    ...
    <>
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-slate-800 mb-6">Help Center</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Welcome to the ChatFlow help center. Here you will find answers to your questions.
          </p>
        </div>
      </section>
          ...
          <Card className="border-0 shadow-lg bg-white/60 backdrop-blur-sm border border-white/20">
            ...
            <CardContent>
              <p className="text-slate-600 leading-relaxed">
                We are working hard to bring you our help center. Please check back later!
              </p>
            </CardContent>
          </Card>
        </div>
